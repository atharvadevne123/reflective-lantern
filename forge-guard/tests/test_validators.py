...
def test_is_valid_returns_true_for_valid() -> None:
...
def test_out_of_range_produces_error(field: str, bad_value: float) -> None:
    from app.validators import validate_sensor_reading
...
def test_missing_field_produces_error() -> None:
    from app.validators import validate_sensor_reading
...
def test_sanitize_fills_missing_with_median() -> None:
...
def test_sanitize_clips_to_range() -> None:
    from app.validators import sanitize_sensor_reading
...
def test_sanitize_handles_non_numeric() -> None:
    from app.validators import sanitize_sensor_reading
...
def test_validate_returns_empty_list_for_boundary_low() -> None:
    from app.validators import validate_sensor_reading
...
def test_validate_returns_errors_for_all_bad_fields() -> None:
    from app.validators import validate_sensor_reading
...
def test_is_valid_false_for_nan() -> None:
    from app.validators import is_valid_sensor_reading

    assert is_valid_sensor_reading({**VALID, "vibration": math.nan}) is False


def test_sanitize_nan_replaced_with_median() -> None:
    from app.validators import sanitize_sensor_reading
...
def test_sanitize_inf_clipped() -> None:
    from app.validators import sanitize_sensor_reading
...
class TestSensorZScore:
    ...
    def test_parametrized(self, value, mean, std, expected) -> None:
        from app.validators import sensor_z_score
...
class TestSensorDriftDetected:
    ...
    def test_parametrized_drift(self, baseline, current, threshold, expected) -> None:
        from app.validators import sensor_drift_detected

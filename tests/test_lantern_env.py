...
class TestCredentialProbe:
    ...
    def test_401_means_credentials_honoured(self, monkeypatch) -> None:
    ...
    def test_200_means_credentials_ignored(self, monkeypatch) -> None:
    ...
    def test_unexpected_status_is_not_a_pass(self, monkeypatch) -> None:
...
class TestEnumerationProbe:
    ...
    def test_error_statuses_mean_blocked(self, monkeypatch, status) -> None:
...
class TestRepoCreationProbe:
    ...
    def test_422_means_creation_permitted(self, monkeypatch) -> None:
    ...
    def test_403_means_forbidden(self, monkeypatch) -> None:
    ...
    def test_probe_sends_invalid_name_so_nothing_is_created(self, monkeypatch) -> None:
        """The probe must post an empty name so no repository can be created."""
        captured: dict = {}

        def fake(path, token=None, method="GET", payload=None) -> None:
            captured["path"] = path
...
class TestSmtpProbe:
    ...
    def test_unreachable_when_connection_fails(self, monkeypatch) -> None:
...
class TestDeliveryFallback:
    ...
    def test_skips_email_without_credentials(self, monkeypatch) -> None:
    ...
    def test_deliver_falls_back_to_file(self, monkeypatch, tmp_path) -> None:
    ...
    def test_deliver_survives_email_exception(self, monkeypatch, tmp_path) -> None:
    ...
    def test_filed_report_contains_body(self, monkeypatch, tmp_path) -> None:

...
def test_predict_after_train(client: TestClient, energy_payload) -> None:
...
def test_predict_no_model(client: TestClient, energy_payload) -> None:
...
def test_anomaly_after_train(client: TestClient, energy_payload) -> None:
    client.post("/api/v1/train")
...
def test_anomaly_no_model(client: TestClient, energy_payload) -> None:
    import app.main as main_mod
...
def test_predict_various_buildings(client: TestClient, energy_payload, building_id) -> None:
    client.post("/api/v1/train")
...
def test_predict_various_hours(client: TestClient, energy_payload, hour) -> None:
    client.post("/api/v1/train")
...
def test_predict_invalid_building_id(client: TestClient, energy_payload) -> None:
...
def test_feature_importance_no_model(client: TestClient) -> None:
    import app.main as main_mod
...
def test_feature_importance_after_train(client: TestClient) -> None:
    client.post("/api/v1/train")
    r = client.get("/api/v1/feature-importance")
    assert r.status_code == 200
    data = r.json()
...
def test_anomaly_stats_endpoint(client: TestClient) -> None:
...
def test_savings_endpoint_mismatched_lengths(client: TestClient) -> None:
    payload = {
        "actual_kwh": [8.0, 9.0],
        "baseline_kwh": [10.0, 11.0, 9.0],
        "tariff_per_kwh": 0.15,
...
def test_efficiency_grade_endpoint(client: TestClient) -> None:
...
def test_predict_boundary_hours(client: TestClient, energy_payload, hour, expected_status) -> None:
    client.post("/api/v1/train")
    payload = {**energy_payload, "hour": hour}
    r = client.post("/api/v1/predict", json=payload)

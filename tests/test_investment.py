...
def test_basic_investment_analysis():
...
def test_zero_value_returns_zero_score():
    result = compute_investment_analysis(
        predicted_value=0,
...
def test_high_yield_raises_score():
...
def test_break_even_decreases_with_higher_yield():
...
def test_amenity_composite_range():

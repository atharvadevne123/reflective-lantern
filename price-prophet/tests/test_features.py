...
def test_competitive_gap_zero_competitor() -> None:
    from app.data.features import competitive_gap

    assert competitive_gap(100.0, 0.0) == 0.0


def test_build_feature_matrix(sample_records) -> None:
...
def test_build_feature_matrix_first_row(sample_records) -> None:
    from app.data.features import build_feature_matrix

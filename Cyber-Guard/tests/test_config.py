...
def test_malformed_float_falls_back(monkeypatch) -> None:
...
def test_malformed_int_falls_back(monkeypatch) -> None:
...
def test_is_sqlite_detection(url: str, expected: bool, monkeypatch) -> None:

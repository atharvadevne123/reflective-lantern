...
class TestBatchPredict:
    ...
    def test_batch_preserves_input_order(self, client, sample_metrics, normal_metrics) -> None:
    ...
    def test_batch_matches_single_predict(self, client, sample_metrics) -> None:
    ...
    def test_batch_validates_each_item(self, client, sample_metrics) -> None:
    ...
    def test_batch_confidences_in_range(self, client, sample_metrics, normal_metrics) -> None:
...
class TestListIncidents:
    ...
    def test_returns_seeded_incident(self, client, db_session) -> None:
    ...
    def test_filter_by_service_name(self, client, db_session) -> None:
    ...
    def test_limit_caps_result_count(self, client, db_session) -> None:
    ...
    def test_limit_bounds_validated(self, client, limit, expected_status) -> None:
        """limit must fall within 1-500."""
        resp = client.get("/api/v1/incidents", params={"limit": limit})
        assert resp.status_code == expected_status

    def test_negative_offset_rejected(self, client) -> None:

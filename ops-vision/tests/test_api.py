...
class TestHealthEndpoint:
    ...
    def test_root_health_returns_ok(self, client) -> None:
        """Root health check should return status ok."""
        resp = client.get("/health")
        assert resp.status_code == 200
        assert resp.json()["status"] == "ok"

    def test_root_health_returns_version(self, client) -> None:
        """Root health check should include a version field."""
        resp = client.get("/health")
        assert "version" in resp.json()

    def test_v1_health_returns_ok(self, client) -> None:
        """API v1 health check should return status ok or degraded."""
        resp = client.get("/api/v1/health")
        assert resp.status_code == 200
        assert resp.json()["status"] in ("ok", "degraded")

    def test_v1_health_has_model_loaded_field(self, client) -> None:
    ...
    def test_v1_health_has_window_sizes(self, client) -> None:
...
class TestVersionEndpoint:
    ...
    def test_version_has_version_key(self, client) -> None:
...
class TestPredictEndpoint:
    ...
    def test_predict_returns_200_with_valid_payload(self, client, sample_metrics) -> None:
        """Predict endpoint accepts valid payload and returns 200."""
        resp = client.post("/api/v1/predict", json=sample_metrics)
        assert resp.status_code == 200

    def test_predict_response_has_required_fields(self, client, sample_metrics) -> None:
    ...
    def test_predict_confidence_in_range(self, client, sample_metrics) -> None:
        """Confidence score must be between 0 and 1."""
        resp = client.post("/api/v1/predict", json=sample_metrics)
        confidence = resp.json()["confidence"]
        assert 0.0 <= confidence <= 1.0

    def test_predict_service_name_echoed(self, client, sample_metrics) -> None:
    ...
    def test_predict_rejects_missing_field(self, client, sample_metrics, missing_field) -> None:
    ...
    def test_predict_empty_service_name_rejected(self, client, sample_metrics) -> None:
    ...
    def test_predict_normal_metrics_returns_low_confidence(self, client, normal_metrics) -> None:
...
class TestArtifactPairing:
    ...
    def test_load_artifacts_returns_fitted_pipeline(self, tmp_path, monkeypatch) -> None:
    ...
    def test_predict_succeeds_on_warm_start(self, client, sample_metrics) -> None:
...
class TestMetricsEndpoint:
    ...
    def test_metrics_has_required_fields(self, client) -> None:
    ...
    def test_metrics_incident_rate_valid(self, client) -> None:
...
class TestRunbookSearch:
    ...
    def test_runbook_search_returns_200(self, client) -> None:
    ...
    def test_runbook_search_returns_list(self, client) -> None:
    ...
    def test_runbook_search_query_too_short_rejected(self, client) -> None:
...
class TestForecastEndpoint:
    ...
    def test_forecast_returns_200(self, client) -> None:
        """Forecast endpoint returns HTTP 200."""
        resp = client.get("/api/v1/forecast")
        assert resp.status_code == 200

    def test_forecast_returns_24_points(self, client) -> None:
        """Forecast returns 24 hourly prediction points."""
        resp = client.get("/api/v1/forecast")
        assert len(resp.json()) == 24

    def test_forecast_points_have_required_fields(self, client) -> None:

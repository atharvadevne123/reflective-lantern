...
class TestAnomalyDetector:
    def test_train_returns_model_and_scaler(self, feature_matrix) -> None:
    ...
    def test_trained_model_is_isolation_forest(self, feature_matrix) -> None:
    ...
    def test_score_anomaly_returns_array(self, trained_models) -> None:
    ...
    def test_scores_in_range_zero_to_one(self, trained_models) -> None:
        from app.model import score_anomaly
    ...
    def test_score_anomaly_without_training_raises(self) -> None:
    ...
    def test_score_single_row(self, trained_models) -> None:
        from app.model import score_anomaly
    ...
    def test_contamination_parameter(self, feature_matrix, contamination) -> None:
        from app.model import train_anomaly_detector
...
class TestForecaster:
    def test_train_forecaster_returns_metrics(self, trained_models) -> None:
        assert "mae" in trained_models["metrics"]
        assert "rmse" in trained_models["metrics"]

    def test_metrics_are_non_negative(self, trained_models) -> None:
        assert trained_models["metrics"]["mae"] >= 0.0
        assert trained_models["metrics"]["rmse"] >= 0.0

    def test_predict_forecast_returns_list(self, trained_models) -> None:
    ...
    def test_predict_forecast_without_training_raises(self) -> None:
        from app import model as m
    ...
    def test_feature_importance_returns_list(self, trained_models) -> None:
    ...
    def test_feature_importance_has_keys(self, trained_models) -> None:
        from app.model import get_feature_importance
    ...
    def test_feature_importance_sorted_descending(self, trained_models) -> None:
        from app.model import get_feature_importance
    ...
    def test_forecast_multiple_horizons(self, trained_models, horizon) -> None:
        from app.model import predict_forecast
...
class TestAnomalyDetectorEdgeCases:
    ...
    def test_scores_array_length_matches_input(self, trained_models) -> None:
        from app.model import score_anomaly
    ...
    def test_scores_all_finite(self, trained_models) -> None:
        import numpy as np
    ...
    def test_forecast_returns_floats(self, trained_models) -> None:
        from app.model import predict_forecast
    ...
    def test_feature_importance_list_not_longer_than_twenty(self, trained_models) -> None:
        from app.model import get_feature_importance

        fi = get_feature_importance(trained_models["rf_model"], trained_models["feature_cols"])
        assert len(fi) <= 20

    def test_metrics_rmse_non_negative(self, trained_models) -> None:
        assert trained_models["metrics"]["rmse"] >= 0.0

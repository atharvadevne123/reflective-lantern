...
class TestGenerateReadings:
    ...
    def test_zero_anomaly_rate(self) -> None:
    ...
    def test_single_reading_valid(self) -> None:
    ...
    def test_count_matches_parametrized(self, n: int) -> None:
